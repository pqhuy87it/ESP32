'''
 09.40 - Use the 0.96" OLED with the SSD1315 controller (software I2C)

 This sketch shows how to display text and graphics in a the SSD1315 OLED display. 
 
  
 Components
 ----------
  - ESP32
  - 0.96" OLED with the SSD1315 controller
  -     GND --> GND
  -     VCC --> 3.3V
  -     SDA --> GPIO 25
  -     SCL --> GPIO 26
