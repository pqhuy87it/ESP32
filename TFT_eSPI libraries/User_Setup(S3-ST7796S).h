// ST7796s 320 x 480 display with no chip select line
...
#define TFT_DC     17
#define TFT_RST    16   // Set TFT_RST to -1 if display RESET is connected to ESP32 board EN
//#define TFT_BL     18   // LED back-light  // TFT_BL -1 gibt Fehlermeldung bei verbose
